...
class WorkflowProcessModel extends BaseModel {
...
//        $wokflow = session('workflow');
     ...
     * 更新进程表
     * @param type $context
     * @param type $context_type
     * @param type $data
     * @return boolean
     */
    public function updateProcess($context, $context_type, $data) {
        $map['context'] = $context;
        $map['context_type'] = $context_type;
