    ...
    <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        <thead>
            <tr>
                ...
                <th data-order-field="pro_account" align="center" width="200">融资金额</th>
                <th data-order-field="addtime" align="center" width="300">添加时间</th>
                <th data-order-field="company" align="center" width="300">公司</th>
                <th data-order-field="pro_linker" align="center" width="100">项目经理</th>
                <th data-order-field="admin_id" align="center" width="100">项管部跟进人</th>
                <th data-order-field="risk_admin_id" align="center" width="100">风控主审人</th>
                <th data-order-field="after_loan_admin" align="center" width="100">贷后跟进人</th>
        ...
        <tbody>
            ...
            <tr data-id="<?php echo $v['pro_id']?>">
                ...
                <td align="center">
                    ...
                    <?php }?>
                    <a href="<?php echo U('Project/detail', array('pro_id'=>$v['pro_id']))?>" class="btn btn-green" data-toggle="dialog" data-mask="true" data-height="750" data-width="1200" data-id="project-detail" data-reload-warn="本页已有打开的内容，确定将刷新本页内容，是否继续？" data-title="项目详情">查看</a>
