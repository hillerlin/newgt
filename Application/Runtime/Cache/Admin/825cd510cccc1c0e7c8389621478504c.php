            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <!--<button data-url="/Admin/Contract/projectAdd.html?pro_id=<?php echo ($pro_id); ?>" class="btn btn-blue" data-toggle="dialog" data-width='800' data-height="420" data-mask='true' data-icon="plus" data-id="project-add">合同预签申请表</button>-->
                        <?php foreach($company_list as $company){ ?>
                        <button data-url="/Admin/Contract/projectAdd.html?pro_id=<?php echo ($pro_id); ?>&company_id=<?php echo $company['company_id']?>" class="btn btn-blue" data-toggle="lookupbtn" data-width='800' data-height="420" data-mask='true' data-icon="plus" data-id="project-add"><?php echo $company['company_name']?></button>
                ...
                <tr>
                    <td>
                        <label for="pro_desc" class="control-label x120">合同预签申请表：</label>
                        <?php foreach($company_list as $company){ ?>
                        <button data-url="/Admin/Contract/edit.html?pro_id=<?php echo ($pro_id); ?>&company_id=<?php echo $company['company_id']?>" class="btn btn-blue" data-toggle="lookupbtn" data-width='800' data-height="420" data-mask='true' data-icon="edit" data-id="project-add"><?php echo $company['company_name']?></button>
                        <!--<input type="hidden" name="contract_save_<?php echo $company['company_id']?>" value="" data-rule="required"/>-->
                        <?php } ?>
                    </td>
                </tr>
