<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<?php echo U('Project/start')?>" method="post">
    ...
    <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        ...
        <tbody>
            ...
            <tr data-id="<?php echo $v['pro_id']?>">
                ...
                <td align="center"><?php echo $v['step_pid'] >1 ? '项目已立项' : $workflow[$v['step_pid']][$v['pro_step']]['step_desc']?></td>
                <td align="center"><?php echo $v['step_pid'] >1 ? '已提交' : ($v['submit_status']==1?'已提交':'草稿')?></td>
                <td align="center">
                    <?php if($v['submit_status'] == 0){?>
                    <a href="<?php echo U('Project/submit', array('pro_id'=>$v['pro_id']))?>" class="btn btn-green" data-toggle="doajax" data-confirm-msg="确定要提交该行信息吗？提交过后您将不能再修改信息！">提交</a>
                    ...
                    <a href="<?php echo U('Project/cancel', array('pro_id'=>$v['pro_id']))?>" class="btn btn-red" data-toggle="doajax" data-confirm-msg="确定要删除该行信息吗？">删</a>
                    <?php }else{ ?>
